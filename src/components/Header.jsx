    ...
    <header className="relative overflow-hidden">
      ...
      >
        ...
        {/* <div className="flex justify-center gap-4">
          ...
          <div className="block sm:hidden text-[20px] text-gray-700 font-medium">
        ...
        <div>
          <img
            src="/GreekGeographySmartLink.png"
            alt="QR code"
            className="rounded-lg shadow-2xl w-1/3 md:w-1/5 lg:w-1/6 mx-auto mt-20"
          />
        </div>
        <div className="mb-30" />
        {/* <button className="bg-white text-blue-600 px-8 py-3 rounded-full font-semibold border-2 border-blue-600 hover:bg-blue-50 transition">
